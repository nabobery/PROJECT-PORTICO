          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-muted-foreground">
                I'm an AI/ML and Full-Stack Software Engineer specializing in
                building intelligent, scalable solutions. My experience spans
                designing dynamic rule engines, RAG pipelines, efficient
                background processing, and interactive dashboards using
                technologies like Python, Java, React, Next.js, and TypeScript.
              </p>

              <p className="text-muted-foreground">
                I enjoy tackling complex problems, bridging the gap between
                robust backend systems and engaging frontend experiences,
                ensuring applications are performant, maintainable, and
                user-friendly.
              </p>
            </motion.div>
