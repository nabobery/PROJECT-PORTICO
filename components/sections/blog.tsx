...
const blogPosts = [
  {
    ...
    excerpt: 'Learn the strategies and techniques for optimizing React applications for maximum performance.',
  ...
  },
  {
    ...
    excerpt: 'Maximize your productivity with these TypeScript tips specifically for React projects.',
    ...
    <section id="blog" className="py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center mb-12">
          ...
          >
            Insights, tutorials, and thoughts on web development, design patterns, and technology trends.
          </motion.p>
        </div>
