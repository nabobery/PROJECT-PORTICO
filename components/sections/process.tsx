...
import { LightbulbIcon, Code, Paintbrush, BarChart3, Rocket } from 'lucide-react';
...
const processSteps = [
  {
    icon: LightbulbIcon,
    title: 'Discovery',
    description: 'Understanding requirements, research, and gathering insights to establish project goals.',
    color: 'hsl(var(--chart-1))'
  },
  {
    icon: Paintbrush,
    title: 'Design',
    description: 'Creating wireframes, prototypes, and visual designs with a focus on user experience.',
    color: 'hsl(var(--chart-2))'
  },
  {
    icon: Code,
    title: 'Development',
    description: 'Writing clean, efficient, and maintainable code following best practices and standards.',
    color: 'hsl(var(--chart-3))'
  },
  {
    icon: BarChart3,
    title: 'Testing',
    description: 'Thorough testing for bugs, performance issues, and ensuring compatibility across devices.',
    color: 'hsl(var(--chart-4))'
  },
  {
    icon: Rocket,
    title: 'Deployment',
    description: 'Launching the project with proper CI/CD pipelines and post-launch monitoring.',
