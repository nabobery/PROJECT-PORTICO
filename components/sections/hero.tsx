      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl">
          <div className="flex flex-col gap-6 text-center md:text-left">
            ...
            >
              Passionate AI/ML and Full-Stack Engineer dedicated to building
              intelligent, scalable solutions. Experienced in developing robust
              applications and systems using diverse technologies.
            </motion.p>
